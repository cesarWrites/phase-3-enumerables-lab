...
def print_spicy_foods(spicy_foods)
  # your code here
  select_spicy_food = spicy_foods.map do |food|
    "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{"🌶" * food[:heat_level]}"
  end
  puts select_spicy_food
end
...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  # your code here
  cuisine_match = spicy_foods.find{|food| food[:cuisine] == cuisine}
end
...
def sort_by_heat(spicy_foods)
  # your code here
  sorted_foods = spicy_foods.sort{|a,b| a[:heat_level] <=> b[:heat_level]}
end
...
def print_spiciest_foods(spicy_foods)
  # your code here
  select_by_heat_level = spicy_foods.select do |food|
